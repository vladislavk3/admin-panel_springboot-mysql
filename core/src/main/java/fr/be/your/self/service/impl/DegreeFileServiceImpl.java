...
import fr.be.your.self.repository.DegreeFileRepository;
import fr.be.your.self.service.DegreeFileService;
import fr.be.your.self.util.StringUtils;

@Service
public class DegreeFileServiceImpl extends BaseServiceImpl<DegreeFile, Integer> implements DegreeFileService  {
	
	@Autowired
	DegreeFileRepository repository;
	...
	@Override
	protected BaseRepository<DegreeFile, Integer> getRepository() {
		return repository;
	}

	@Override
	protected Iterable<DegreeFile> getList(String text, Sort sort) {
		if ( StringUtils.isNullOrSpace(text) ) {
	...
	@Override
	protected Page<DegreeFile> getListByPage(String text, Pageable pageable) {
		if ( StringUtils.isNullOrSpace(text) ) {
